...
//   .flex [&>div]:p-4 rounded-lg shadow-md border overflow-hidden
//      .flex-1                                  .flex-1.bg-green-500.text-white.flex.items-ce…
  ...
  return (
    <div className="grid h-full place-items-center px-10">
      <div className="flex w-full overflow-hidden rounded-lg border shadow-md [&>div]:p-4">
        ...
        <div className="flex-1 bg-zinc-800 text-white">right</div>
      </div>
    </div>
  );
}
